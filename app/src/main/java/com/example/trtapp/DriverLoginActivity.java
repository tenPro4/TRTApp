    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user != null){
                    Intent intent = new Intent(DriverLoginActivity.this,DMapActivity.class);
...
//        });
        ...
        mLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(DriverLoginActivity.this, "Email is empty!", Toast.LENGTH_SHORT).show();
                }
                else if (TextUtils.isEmpty(password))
                {
                    ...
                    if(accessType.toLowerCase().equals("login")){
                        AllowAccessToAccount(email, password,"Driver");
                    }else{
                        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(DriverLoginActivity.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
