...
public class HistoryActivity extends AppCompatActivity {
    ...
    private void payoutRequest() {
        ...
        final Request request = new Request.Builder()
                .url("https://us-central1-trtapp-fe3d7.cloudfunctions.net/payout")
                .post(body)
...
//                            Balance += ridePrice;
//                            mBalance.setText("Balance: RM" + Balance);
//                        }
//                    }
                    if(dataSnapshot.child("price").getValue() != null && dataSnapshot.child("customerPaid").getValue().toString().equals("true")
                            && !dataSnapshot.child("driverPaidOut").getValue().toString().equals("true")){
                        ridePrice = Double.valueOf(dataSnapshot.child("price").getValue().toString());
                        Balance += Double.valueOf(String.format("%.2f",ridePrice));
                        mBalance.setText("Balance: RM" + Balance);
                    }
